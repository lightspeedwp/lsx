			  	...
			  	<div class="row">
			    	<div class="col-sm-12">
			    		...
			    		<?php lsx_footer_top(); ?>
			      		...
			      		<p class="credit <?php if ( has_nav_menu( 'social' ) || has_nav_menu( 'footer' ) ) { ?>credit-float<?php } ?>"><?php printf( esc_html__( '&#169; %1$s %2$s All Rights Reserved.', 'lsx' ), esc_html( date_i18n( 'Y' ) ), get_bloginfo( 'name' ) ); ?></p>
