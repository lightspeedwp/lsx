							...
							<?php if ( apply_filters( 'lsx_credit_link', true ) ) : ?>
								<?php
									printf(
										...
										'LSX',
										'<a href="https://www.lsdev.biz/" title="LightSpeed WordPress Development - Unlocking the full value of your business, online" rel="author nofollow noopener noreferrer" >LightSpeed</a>'
									);
								?>
							<?php endif; ?>
						</p>
