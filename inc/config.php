 ...
 * @subpackage config
 */
function lsx_theme_settings_setup() {
	add_submenu_page('themes.php', 'LSX Theme', 'LSX Theme', 'manage_options', 'lsx-theme-options', 'lsx_theme_settings'); 
}
add_action( 'admin_menu', 'lsx_theme_settings_setup' );
 ...
 * @subpackage config
 */
function lsx_theme_settings() {
	?>
	<div class="wrap">
		<h1>LSX Theme</h1>

		<?php if ( isset( $_GET['settings-updated'] ) ) : ?>
			<div id="lsx_theme_settings_message" class="updated notice is-dismissible">
		...
		<form method="post" action="options.php">
			<?php
				settings_fields( 'lsx_theme_settings_section' );
				do_settings_sections( "lsx_theme_settings_options" );      
				submit_button(); 
			?>          
		</form>
	</div>
 ...
 * @subpackage config
 */
function lsx_theme_settings_field_lazyload_status() {
	$lsx_lazyload_status = get_option( 'lsx_lazyload_status' );
	if ( $lsx_lazyload_status === false ) $lsx_lazyload_status = 1;
	?>
	<input type="checkbox" name="lsx_lazyload_status" id="lsx_lazyload_status" value="1" <?php checked( '1', $lsx_lazyload_status ) ?>>
	<?php
}
...
add_action( 'admin_init', 'lsx_theme_settings_fields' );
