...
function lsx_body_class($classes) {
  ...
  if(is_singular($post_types) && has_post_thumbnail() && !is_front_page() || is_single() && has_post_thumbnail() && !is_front_page()){
...
if(!function_exists('lsx_page_banner')){
	function lsx_page_banner() {
		...
		if ( is_singular($post_types) && has_post_thumbnail() || is_single() && has_post_thumbnail() ) { ?>
