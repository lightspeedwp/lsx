...
function lsx_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		<div class="nav-links pager row">
			...
			?>
			<?php
				$next_post = get_next_post_link(     '%link', _x( '<div class="next"><p class="nav-links-description">Previous Post:</p>%title <span class="meta-nav">&rarr;</span></div>', 'Next post link',     'lsx' ) );
