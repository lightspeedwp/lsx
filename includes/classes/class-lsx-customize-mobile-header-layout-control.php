			...
			<label>
				...
				<div class="mobile-header-layouts-selector">
					...
					foreach ( $this->layouts as $layout ) {
						...
						echo '<img class="mobile-header-layout-button" style="padding:2px;' . esc_attr( $sel ) . '" src="' . esc_attr( get_template_directory_uri() ) . '/assets/images/admin/header-' . esc_attr( $layout ) . '.png" data-option="' . esc_attr( $layout ) . '">';
					}
					?>
