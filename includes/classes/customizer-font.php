...
if ( ! class_exists( 'LSX_Customize_Font_Control' ) ) :
	...
	class LSX_Customize_Font_Control extends WP_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_style( 'lsx-font-picker-custom-control', get_template_directory_uri() . '/assets/css/lsx-admin-customizer-font.css', array(), LSX_VERSION );
			wp_enqueue_script( 'lsx-font-picker-custom-control', get_template_directory_uri() . '/assets/js/lsx-admin-customizer-font.js', array(), LSX_VERSION );
		}
