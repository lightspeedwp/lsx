...
<figure class="wp-block-image size-full"><img src="' .   esc_url( get_theme_file_uri() ) . '/assets/images/sample-black_1200x1200.jpg'. '"  alt="' .   esc_attr__( 'Sample Image', 'lsx' ). '" class="wp-image-676"/></figure>
<!-- /wp:image -->
