...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link no-border-radius wp-element-button">Get Started</a></div>
<!-- /wp:button -->
...
<!-- /wp:button --></div>
<!-- /wp:buttons --></div><figure class="wp-block-media-text__media"><img alt="" class="wp-image-3485 size-full"/></figure></div>
<!-- /wp:media-text --></div>
<!-- /wp:group -->',
);
