 ...
 */
return array(
	'title'	  => __( 'Footer Mega Contrast', 'lsx' ),
...
<h4 id="our-company">' .  esc_html__( 'Our Company', 'lsx' ). '</h4>
<!-- /wp:heading -->
<!-- wp:paragraph -->
...
<div class="wp-block-button is-style-fill-base"><a class="wp-block-button__link no-border-radius wp-element-button" href="#">' .  esc_html__( 'Learn More', 'lsx' ). '</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
<!-- wp:column {"width":"15%"} -->
<div class="wp-block-column" style="flex-basis:15%"><!-- wp:heading {"level":4} -->
<h4 id="about-us">' .  esc_html__( 'About Us', 'lsx' ). '</h4>
<!-- /wp:heading -->
<!-- wp:list {"fontSize":"small"} -->
<ul class="has-small-font-size"><!-- wp:list-item -->
<li><a href="#">' .  esc_html__( 'Start Here', 'lsx' ). '</a></li>
<!-- /wp:list-item -->
<!-- wp:list-item -->
<li><a href="#">' .  esc_html__( 'Our Mission', 'lsx' ). '</a></li>
<!-- /wp:list-item -->
<!-- wp:list-item -->
<li><a href="#">' .  esc_html__( 'Brand Guide', 'lsx' ). '</a></li>
<!-- /wp:list-item -->
<!-- wp:list-item -->
<li><a href="#">' .  esc_html__( 'Newsletter', 'lsx' ). '</a></li>
<!-- /wp:list-item -->
<!-- wp:list-item -->
<li><a href="#">' .  esc_html__( 'Accessibility', 'lsx' ). '</a></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:column -->
<!-- wp:column {"width":"15%"} -->
<div class="wp-block-column" style="flex-basis:15%"><!-- wp:heading {"level":4} -->
<h4 id="services">' .  esc_html__( 'Services', 'lsx' ). '</h4>
<!-- /wp:heading -->
<!-- wp:list {"fontSize":"small"} -->
<ul class="has-small-font-size"><!-- wp:list-item -->
<li><a href="#">' .  esc_html__( 'Web Design', 'lsx' ). '</a></li>
<!-- /wp:list-item -->
<!-- wp:list-item -->
<li><a href="#">' .  esc_html__( 'Development', 'lsx' ). '</a></li>
<!-- /wp:list-item -->
<!-- wp:list-item -->
<li><a href="#">' .  esc_html__( 'Copywriting', 'lsx' ). '</a></li>
<!-- /wp:list-item -->
<!-- wp:list-item -->
<li><a href="#">' .  esc_html__( 'Marketing', 'lsx' ). '</a></li>
<!-- /wp:list-item -->
<!-- wp:list-item -->
<li><a href="#">' .  esc_html__( 'Social Media', 'lsx' ). '</a></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:column -->
<!-- wp:column {"width":"15%"} -->
<div class="wp-block-column" style="flex-basis:15%"><!-- wp:heading {"level":4} -->
<h4 id="connect">' .  esc_html__( 'Connect', 'lsx' ). '</h4>
<!-- /wp:heading -->
<!-- wp:list {"fontSize":"small"} -->
<ul class="has-small-font-size"><!-- wp:list-item -->
