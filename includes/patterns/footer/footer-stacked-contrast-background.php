 ...
 */
return array(
	'title'	  => __( 'Footer Stacked Contrast', 'lsx' ),
...
<h2 class="has-text-align-center has-max-48-font-size" id="let-s-connect" style="font-style:normal;font-weight:400;margin-bottom:20px">' .  esc_html__( 'Let’s Connect', 'lsx' ). '</h2>
<!-- /wp:heading -->
...
<div class="wp-block-button is-style-outline-base"><a class="wp-block-button__link no-border-radius" href="#">' .  esc_html__( 'Get in Touch', 'lsx' ). ' →</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
<!-- wp:paragraph {"align":"center","fontSize":"small"} -->
<p class="has-text-align-center has-small-font-size">© ' .  esc_html( gmdate( 'Y' ) ). ' Your Company LLC · <a href="#">' .  esc_html__( 'Contact Us', 'lsx' ). '</a></p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->',
);
