...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link no-border-radius" href="#">' .  esc_html__( 'Get in Touch', 'lsx' ). ' →</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
