...
function lsx_scripts() {
	...
	wp_enqueue_style('lsx-header-font', $http_var.'://fonts.googleapis.com/css?family='.$header_font_location);
	wp_enqueue_style('lsx-body-font', $http_var.'://fonts.googleapis.com/css?family='.$body_font_location);
